...
<div class="form-group">
    ...
    {!! Form::label('name', __('Penjahit'), ['class' => 'col-md-2 col-sm-2 control-label']) !!}
    <div class="col-md-4 col-sm-4 {{ $errors->has('production_id') ? 'has-error' : ''}}">
        {{ Form::select('production_id', $production, request()->get('production_id') ?? null, ['class'=> 'form-control ']) }}
        {!! $errors->first('production_id', '<p class="help-block">:message</p>') !!}
    </div>

    
    {!! Form::label('name', __('Status'), ['class' => 'col-md-2 col-sm-2 control-label']) !!}
    <div class="col-md-4 col-sm-4 {{ $errors->has('spk_status') ? 'has-error' : ''}}">
        {{ Form::select('spk_status', $status, request()->get('spk_status') ?? null, ['class'=> 'form-control ']) }}
        {!! $errors->first('spk_status', '<p class="help-block">:message</p>') !!}
    </div>
