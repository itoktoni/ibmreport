...
class Po extends Model
{
    ...
    public $datatable = [
        'purchase_id' => [true => 'Code'],
        'purchase_date' => [true => 'Code'],
        'supplier_id' => [false => 'Company'],
        'purchase_status' => [true => 'Status', 'width' => 50, 'class' => 'text-center', 'status' => 'status'],
    ];
    ...
    {
        return $this->hasMany(PoDetail::class, 'detail', 'purchase_id');
    }

    public function has_payment()
    {
        return $this->hasMany(Payment::class, 'reference', 'purchase_id');
    }
